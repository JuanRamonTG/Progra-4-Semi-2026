const busqueda_registrofallecido = {
    props:['forms'],
    data(){
        return{
            busqueda:{
    ...
    methods:{
        async buscar() {
            ...
            if(this.busqueda.estado) {
                params.append('estado', this.busqueda.estado);
            }
            ...
            try {
                let response = await fetch((window.assetBase || '') + `private/modulos/registrofallecido/registrofallecido.php?${params}`, {
                    method: 'GET',
    ...
    template: `
        <div v-if="mostrar" class="card card-outline card-danger mb-3">
            <div class="card-header">
                <h3 class="card-title fw-bold"><i class="fas fa-search"></i> BUSCAR REGISTRO DE FALLECIDO</h3>
            </div>
            <div class="card-body">
                <div class="row">
            ...
            <div class="card-footer">
                <button @click="buscar" class="btn btn-danger">
